...
import com.example.foodie.chefFoodPanel.*;
...
public class PendingOrdersAdapter extends RecyclerView.Adapter<PendingOrdersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Price.setText("Price: BDT " + customerPendingOrders.getPrice());
        holder.Quantity.setText("× " + customerPendingOrders.getDishQuantity());
        holder.Totalprice.setText("Total: BDT " + customerPendingOrders.getTotalPrice());
