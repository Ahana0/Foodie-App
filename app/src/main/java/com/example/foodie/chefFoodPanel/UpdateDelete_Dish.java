...
import com.example.foodie.ChefFoodPanel_BottomNavigation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firebaseDatabase.getInstance().getReference("FoodDetails").child(area).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodDetails").child(area).child(useridd).child(ID);
