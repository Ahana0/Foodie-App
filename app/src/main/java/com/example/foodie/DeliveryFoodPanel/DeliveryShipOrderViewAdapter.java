...
public class DeliveryShipOrderViewAdapter extends RecyclerView.Adapter<DeliveryShipOrderViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mcontext).inflate(R.layout.shiporderview2, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.price.setText("Price: BDT " + deliveryShipFinalOrders.getDishPrice());
        holder.quantity.setText("× " + deliveryShipFinalOrders.getDishQuantity());
        holder.totalprice.setText("Total: BDT " + deliveryShipFinalOrders.getTotalPrice());
    }
