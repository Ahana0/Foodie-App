...
public class LoginDelivery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_delivery);
        ...
        Signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    final ProgressDialog mDialog = new ProgressDialog(LoginDelivery.this);
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (FAuth.getCurrentUser().isEmailVerified()) {
                                    mDialog.dismiss();
                                    Toast.makeText(LoginDelivery.this, "You are logged in", Toast.LENGTH_SHORT).show();
                                    Intent z = new Intent(LoginDelivery.this, DeliveryFoodPanel_NavigationBottom.class);
                                    startActivity(z);
                                    finish();
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent Register = new Intent(LoginDelivery.this, RegistrationDelivery.class);
        ...
        Forgotpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(LoginDelivery.this, DeliveryForgotPassword.class);
                startActivity(a);
                finish();
        ...
        Signinphone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent q = new Intent(LoginDelivery.this, Delivery_LoginPhone.class);
                startActivity(q);
                finish();
            }
        });
